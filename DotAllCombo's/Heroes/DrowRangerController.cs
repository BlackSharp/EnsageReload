...
namespace DotaAllCombo.Heroes
{
    ...
    internal class DrowRangerController : Variables, IHeroController
    {
        ...
        public void Combo()
        {
            ...
            _w = Me.FindSpell("drow_ranger_silence");
            ...
            if (Active)
            {
                if (!_q.CanBeCasted() || !Menu.Item("Skills").GetValue<AbilityToggler>().IsEnabled(_q.Name))
                {
            ...
            {
                if (
                    _w != null && _w.CanBeCasted() && Me.Distance2D(E) <= _w.GetCastRange()
                ...
                if (_urn != null && _urn.CanBeCasted() && _urn.CurrentCharges > 0 && Me.Distance2D(E) <= 700
