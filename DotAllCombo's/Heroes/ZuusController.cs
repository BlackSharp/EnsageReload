                        ...
                        if (!CanIncreaseMagicDmg(me, v))
                        {
                               ...
                               && Utils.SleepCheck("W"))
                            {
                                ...
                                Utils.Sleep(250, "W");
								    ...
								    && !v.IsFullMagiclResistZuus() && Units.Count(x => x.Distance2D(pos) <= 300) == 0 && me.Distance2D(v) <= W.GetCastRange() + me.HullRadius + 300 && Menu.Item("AutoSpells").GetValue<AbilityToggler>().IsEnabled(W.Name)
                              && Utils.SleepCheck("W"))
                            {
                                W.UseAbility(pos);
                                Utils.Sleep(250, "W");
