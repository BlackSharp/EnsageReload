        ...
        public void Combo()
        {
            ...
            if (Active && Me.IsAlive)
            {
                ...
                if (E.IsVisible && Me.Distance2D(E) <= 2300 && !noBlade)
                {
                    ...
                    if (_r != null && (_r.IsInAbilityPhase || Me.HasModifier("modifier_nyx_assassin_vendetta") ||
                                       _r.IsChanneling)) return;
                        ...
                        || !Menu.Item("Skills").GetValue<AbilityToggler>().IsEnabled(_r.Name))
                    {
                                 ...
                                 .IsEnabled(_ethereal.Name)))
                        {
                            ...
                            if ( // Dagon
                                Me.CanCast()
                                && _dagon != null
                                && (_ethereal == null || E.HasModifier("modifier_item_ethereal_blade_slow") || _ethereal.Cooldown < 18)
                                && !E.IsLinkensProtected()
                                && _dagon.CanBeCasted()
