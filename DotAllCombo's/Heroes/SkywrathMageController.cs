...
namespace DotaAllCombo.Heroes
{
    ...
    internal class SkywrathMageController : Variables, IHeroController
    {
        ...
        public void OnLoadEvent()
        {
            ...
            _ult.AddItem(new MenuItem("AutoAbility", "AutoAbility").SetValue(new AbilityToggler(
        ...
        public void Combo()
        {
            ...
            if (Active && Me.IsAlive && E.IsAlive && Utils.SleepCheck("activated"))
            {
                ...
                if (E.IsVisible && Me.Distance2D(E) <= 2300)
                {
                    ...
                    if (_e == null || !_e.CanBeCasted() || Me.IsSilenced() ||
                        Me.Position.Distance2D(E) > _e.GetCastRange() + Me.HullRadius || !Menu.Item("Skills")
                            ...
                            .IsEnabled(_e.Name))
                    {
                        ...
                        var pos = new Vector3((float) (E.Position.X - 500 * Math.Cos(angle)),
                            (float) (E.Position.Y - 500 * Math.Sin(angle)), 0);
                        if (
                            _blink != null
                            && _q.CanBeCasted()
                            && Me.CanCast()
                        ...
                        if (!_orchid.CanBeCasted() || _orchid == null || Me.IsSilenced() || !Menu.Item("Items")
                                .GetValue<AbilityToggler>()
                                .IsEnabled(_orchid.Name))
                        {
                            if ( // vail
                                _vail != null
                                && _vail.CanBeCasted()
                            ...
                            if (_vail == null || !_vail.CanBeCasted() || Me.IsSilenced() || !Menu.Item("Items")
                                    .GetValue<AbilityToggler>()
                                    .IsEnabled(_vail.Name))
                            {
                                ...
                                if (_ethereal == null || !_ethereal.CanBeCasted() || Me.IsSilenced() || !Menu
                                        .Item("Items")
                                        .GetValue<AbilityToggler>()
                                        .IsEnabled(_ethereal.Name))
                                {
                                    if (
                                        _q != null
                                        && _q.CanBeCasted()
                                    ...
                                    if (
                                        ...
                                        && !E.IsMagicImmune() && E.FindSpell("abaddon_borrowed_time").Cooldown > 0 && !E.HasModifier("modifier_abaddon_borrowed_time_damage_redirect") && (E.FindItem("item_cyclone") != null &&
                                                                                                                                                                                           E.FindItem("item_cyclone").Cooldown > 0
                                                                                                                                                                                           || (E.FindItem("item_cyclone") == null || E.IsStunned() || E.IsHexed() ||
                                                                                                                                                                                               E.IsRooted())) && (E.FindItem("item_force_staff") != null &&
                                                                                                                                                                                                                  E.FindItem("item_force_staff").Cooldown > 0
                                                                                                                                                                                                                  || (E.FindItem("item_force_staff") == null || E.IsStunned() ||
                                                                                                                                                                                                                      E.IsHexed() || E.IsRooted())) && Menu.Item("Skills").GetValue<AbilityToggler>().IsEnabled(_r.Name) && Utils.SleepCheck("R"))
                                    {
                                    ...
                                    if ( // Dagon
                                        Me.CanCast()
                                        && _dagon != null
                                        && (_ethereal == null || E.HasModifier("modifier_item_ethereal_blade_slow") || _ethereal.Cooldown < 17)
                                        && !E.IsLinkensProtected()
                                        && _dagon.CanBeCasted()
        ...
        public void A()
        {
            ...
            var v =
                ObjectManager.GetEntities<Hero>()
                    .Where(x => x.IsVisible && x.IsAlive && x.IsValid && x.Team != Me.Team && !x.IsIllusion)
                    .ToList();
            ...
            if (Menu.Item("autoUlt").GetValue<bool>() && Me.IsAlive)
            {
                ...
                for (var i = 0; i < ecount; ++i)
                {
                    ...
                    if (Me.HasModifier("modifier_spirit_breaker_charge_of_darkness_vision"))
                    {
                        ...
                        {
                            var angle = Me.FindAngleBetween(v[i].Position, true);
                            var pos = new Vector3((float) (Me.Position.X + 100 * Math.Cos(angle)),
                    ...
                    if (_r != null && _r.CanBeCasted() && Me.Distance2D(v[i]) <= _r.GetCastRange() + 100
                        ...
                        (v[i].HasModifier("modifier_meepo_earthbind")
                         ...
                         || v[i].IsStunned())
                        && (v[i].FindItem("item_cyclone") != null && v[i].FindItem("item_cyclone").Cooldown > 0 || (v[i].FindItem("item_cyclone") == null || v[i].IsStunned()) || v[i].IsHexed() || v[i].IsRooted())
                        && (v[i].FindItem("item_force_staff") != null && v[i].FindItem("item_force_staff").Cooldown > 0 || (v[i].FindItem("item_force_staff") == null || v[i].IsStunned()) || v[i].IsHexed() || v[i].IsRooted()) && (!v[i].HasModifier("modifier_medusa_stone_gaze_stone")
                                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                                     && (v[i].FindSpell("abaddon_borrowed_time") != null
                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                         || v[i].FindSpell("abaddon_borrowed_time") == null)) && v[i].Health >= v[i].MaximumHealth / 100 * Menu.Item("Healh").GetValue<Slider>().Value && !v[i].IsMagicImmune() && Menu.Item("AutoAbility").GetValue<AbilityToggler>().IsEnabled(_r.Name) && Utils.SleepCheck(v[i].Handle.ToString())
                    )
                    {
                    ...
                    if (_r != null && _r.CanBeCasted() && Me.Distance2D(v[i]) <= _r.GetCastRange() + 100
                        ...
                        && (v[i].FindSpell("abaddon_borrowed_time") != null
                            ...
                            || v[i].FindSpell("abaddon_borrowed_time") == null)
                        && (v[i].FindItem("item_cyclone") != null && v[i].FindItem("item_cyclone").Cooldown > 0 || (v[i].FindItem("item_cyclone") == null || v[i].IsStunned()) || v[i].IsHexed() || v[i].IsRooted())
                        && (v[i].FindItem("item_force_staff") != null && v[i].FindItem("item_force_staff").Cooldown > 0 || (v[i].FindItem("item_force_staff") == null || v[i].IsStunned()) || v[i].IsHexed() || v[i].IsRooted())
                    ...
                    if (_e != null && !_e.CanBeCasted() && !v[i].IsStunned() && !v[i].IsHexed() && !v[i].IsRooted() &&
                        (_orchid != null && _orchid.CanBeCasted() || _sheep != null && _sheep.CanBeCasted()))
                        _e = _orchid ?? _sheep;
                    if (_e != null && v[i].HasModifier("modifier_skywrath_mystic_flare_aura_effect")
                        ...
                        && (v[i].FindItem("item_manta") != null && v[i].FindItem("item_manta").Cooldown > 0 || (v[i].FindItem("item_manta") == null || v[i].IsStunned()) || v[i].IsHexed() || v[i].IsRooted())
                    ...
                    if (_e != null && _e.CanBeCasted() && Me.Distance2D(v[i]) <= _e.GetCastRange()
                        ...
                        (v[i].HasModifier("modifier_meepo_earthbind")
                         ...
                         || v[i].FindSpell("antimage_blink") != null &&
                    ...
                    if (v[i].IsLinkensProtected() && (Me.IsVisibleToEnemies || Active) &&
                        Utils.SleepCheck(v[i].Handle.ToString()))
                    {
