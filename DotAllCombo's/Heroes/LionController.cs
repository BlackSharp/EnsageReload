...
namespace DotaAllCombo.Heroes
{
    ...
    internal class LionController : Variables, IHeroController
    {
        ...
        public void Combo()
        {
            ...
            {
                var hexMod = E.Modifiers.Where(y => y.Name == "modifier_lion_voodoo" ||
                                                    y.Name == "modifier_sheepstick_debuff" ||
                                                    y.Name == "modifier_lion_impale")
                    .DefaultIfEmpty(null)
                    .FirstOrDefault();
                ...
                foreach (var v in enemies)
                {
                    ...
                    if (_w != null && v != null && _w.CanBeCasted() && Me.Distance2D(v) <= _w.GetCastRange() + 30
                        ...
                        (
                            ...
                            v.FindSpell("antimage_blink").IsInAbilityPhase
                            ||
                            v.ClassId == ClassId.CDOTA_Unit_Hero_AntiMage &&
