...
namespace DotaAllCombo.Service
{
	...
	class MainMenu
	{
        ...
        private static Menu lastHitOptions;
        ...
        public static Menu LastHitOptions { get { return lastHitOptions; } }
		...
		public static void Load()
		{
            ...
            lastHitOptions = new Menu("LastHitOptions", "lastHitOptions");
            ...
            lastHitOptions.AddItem(new MenuItem("maxDamage", "Maximum damage to off predict").SetValue(new Slider(100, 50, 200)).SetTooltip("If you have > damage predictdamage off"));
            lastHitOptions.AddItem(new MenuItem("PredDamage", "Predict Damage").SetValue(true));

            lastHitOptions.AddItem(new MenuItem("bonusRange", "Maximum bonus Farm Range").SetValue(new Slider(300, 0, 500)));
            lastHitMenu.AddSubMenu(lastHitOptions);
