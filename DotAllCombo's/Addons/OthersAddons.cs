...
#pragma warning disable CS0414 // The field 'OthersAddons._load' is assigned but its value is never used
        ...
        private void Drawing_OnDraw(EventArgs args)
        {
            ...
            {
                var item =
                    Me.Inventory.Items.FirstOrDefault(x => x != null && x.IsValid &&
                                                           (x.Name.Contains("item_dragon_lance") ||
                                                            x.Name.Contains("item_hurricane_pike")));

                if (Me.ClassId == ClassId.CDOTA_Unit_Hero_TrollWarlord &&
                    Me.HasModifier("modifier_troll_warlord_berserkers_rage"))
                ...
                else if (Me.ClassId == ClassId.CDOTA_Unit_Hero_DragonKnight &&
                         Me.HasModifier("modifier_dragon_knight_dragon_form"))
                    _attackRange = Me.GetAttackRange() + Me.HullRadius + 24;
